...
Status: accepted on 2026-09-06; implemented on `codex/order-export-details` in `.claude/worktrees/order-export-details`.
...
Implementation includes the history payload, export DTOs, CSV and landscape PDF, localized in Indonesian and English. The original checkout remains unchanged.
