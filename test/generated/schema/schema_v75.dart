...
class Visits extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> memberAttributionVersion =
      GeneratedColumn<int>(
...
class VenueSettings extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> tableExpenseEnabled = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (table_expense_enabled IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> memberMirrorEnabled = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 1 CHECK (member_mirror_enabled IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
...
class TableSessions extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> expenseAmount = GeneratedColumn<int>(
    'expense_amount',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class VisitExpenses extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VisitExpenses(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'visit_expenses';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
  ...
  @override
  VisitExpenses createAlias(String alias) {
    return VisitExpenses(attachedDatabase, alias);
  }
...
class VisitExpenseCategories extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VisitExpenseCategories(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'visit_expense_categories';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
  ...
  @override
  VisitExpenseCategories createAlias(String alias) {
    return VisitExpenseCategories(attachedDatabase, alias);
  }
...
class CashEntries extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> boxId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'box-main\'',
    defaultValue: const CustomExpression('\'box-main\''),
  );
...
class CashBoxes extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CashBoxes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  CashBoxes createAlias(String alias) {
    return CashBoxes(attachedDatabase, alias);
  }
...
class CashCategories extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CashCategories(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> boxId = GeneratedColumn<String>(
    'box_id',
    aliasedName,
    false,
  ...
  @override
  List<GeneratedColumn> get $columns => [boxId, id, name, active, sortOrder];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'cash_categories';
  @override
  Set<GeneratedColumn> get $primaryKey => {boxId, id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
    throw UnsupportedError('TableInfo.map in schema verification code');
  }
  ...
  @override
  CashCategories createAlias(String alias) {
    return CashCategories(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(box_id, id)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class MemberTombstones extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MemberTombstones(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  MemberTombstones createAlias(String alias) {
    return MemberTombstones(attachedDatabase, alias);
  }
...
class DatabaseAtV75 extends GeneratedDatabase {
  DatabaseAtV75(QueryExecutor e) : super(e);
  ...
  late final VisitExpenses visitExpenses = VisitExpenses(this);
  late final VisitExpenseCategories visitExpenseCategories =
      VisitExpenseCategories(this);
  ...
  late final CashBoxes cashBoxes = CashBoxes(this);
  late final CashCategories cashCategories = CashCategories(this);
  late final Members members = Members(this);
  late final MemberTombstones memberTombstones = MemberTombstones(this);
