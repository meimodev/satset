...
String capabilityLabel(AppL10n l10n, Capability c) => switch (c) {
  ...
  Capability.sellOpenItem => l10n.capSellOpenItem,
  ...
  Capability.recordTableExpense => l10n.capRecordTableExpense,
...
String capabilityDescription(AppL10n l10n, Capability c) => switch (c) {
  ...
  Capability.sellOpenItem => l10n.capSellOpenItemDesc,
  ...
  Capability.recordTableExpense => l10n.capRecordTableExpenseDesc,
