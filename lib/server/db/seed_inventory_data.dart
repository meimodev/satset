...
const seedIngredients = <SeedIngredient>[
  // — staples ————————————————————————————————————————————————
  SeedIngredient('beras', 'Beras', _kg,
      opening: 25, lowAt: 6, pricePerUnit: 23000),
  SeedIngredient('mie', 'Mie telur', _kg,
      opening: 8, lowAt: 2, pricePerUnit: 33000),
  SeedIngredient('tepung', 'Tepung terigu', _kg,
      opening: 6, lowAt: 2, pricePerUnit: 15500),
  SeedIngredient('minyak', 'Minyak goreng', _l,
      opening: 20, lowAt: 5, pricePerUnit: 27000),
  SeedIngredient('garam', 'Garam', _kg,
      opening: 3, lowAt: 1, pricePerUnit: 12000),
  SeedIngredient('gula', 'Gula pasir', _kg,
      opening: 8, lowAt: 2, pricePerUnit: 24000),
  SeedIngredient('kecap', 'Kecap manis', _l,
      opening: 5, lowAt: 1.5, pricePerUnit: 42000),
  SeedIngredient('santan', 'Santan', _l,
      opening: 6, lowAt: 1.5, pricePerUnit: 23000),

  // — protein ————————————————————————————————————————————————
  SeedIngredient('telur', 'Telur ayam', _butir,
      opening: 120, lowAt: 24, pricePerUnit: 4500),
  SeedIngredient('ayam', 'Daging ayam', _kg,
      opening: 12, lowAt: 3, pricePerUnit: 68000),
  SeedIngredient('sapi', 'Daging sapi', _kg,
      opening: 8, lowAt: 2, pricePerUnit: 162000),
  // Seeded below its threshold on purpose — the one low-stock badge.
  SeedIngredient('udang', 'Udang', _kg,
      opening: 1.2, lowAt: 1.5, pricePerUnit: 130000),
  SeedIngredient('tahu', 'Tahu', _pcs,
      opening: 60, lowAt: 15, pricePerUnit: 3500),
  SeedIngredient('tempe', 'Tempe (papan)', _pcs,
      opening: 30, lowAt: 8, pricePerUnit: 7000),

  // — sayur & buah ————————————————————————————————————————————
  SeedIngredient('sayur', 'Sayur campur', _kg,
      opening: 10, lowAt: 3, pricePerUnit: 27000),
  SeedIngredient('kentang', 'Kentang', _kg,
      opening: 10, lowAt: 3, pricePerUnit: 19500),
  SeedIngredient('kacang-tanah', 'Kacang tanah', _kg,
      opening: 5, lowAt: 1.5, pricePerUnit: 43000),
  SeedIngredient('cabai', 'Cabai merah', _kg,
      opening: 4, lowAt: 1, pricePerUnit: 84000),
  SeedIngredient('bawang-merah', 'Bawang merah', _kg,
      opening: 4, lowAt: 1, pricePerUnit: 60000),
  SeedIngredient('bawang-putih', 'Bawang putih', _kg,
      opening: 2.5, lowAt: 0.8, pricePerUnit: 57000),
  SeedIngredient('pisang', 'Pisang kepok', _pcs,
      opening: 80, lowAt: 20, pricePerUnit: 3000),

  // — dapur kering & bar ——————————————————————————————————————
  SeedIngredient('krupuk', 'Krupuk udang', _pcs,
      opening: 200, lowAt: 50, pricePerUnit: 1600),
  SeedIngredient('kulit-lumpia', 'Kulit lumpia', _lembar,
      opening: 200, lowAt: 50, pricePerUnit: 1100),
  SeedIngredient('tusuk-sate', 'Tusuk sate', _pcs,
      opening: 500, lowAt: 100, pricePerUnit: 200),
  SeedIngredient('es-krim', 'Es krim vanila', _l,
      opening: 4, lowAt: 1, pricePerUnit: 77000),
  SeedIngredient('teh', 'Teh melati', _kg,
      opening: 1.5, lowAt: 0.4, pricePerUnit: 135000),
  SeedIngredient('es-batu', 'Es batu', _kg,
      opening: 30, lowAt: 8, pricePerUnit: 4500),
  SeedIngredient('patty-wagyu', 'Patty wagyu', _pcs,
      opening: 24, lowAt: 6, pricePerUnit: 44000),
  SeedIngredient('roti-burger', 'Roti burger', _pcs,
      opening: 30, lowAt: 8, pricePerUnit: 8000),
  SeedIngredient('keju', 'Keju lembar', _lembar,
      opening: 60, lowAt: 15, pricePerUnit: 4000),
  // A bottled drink is a bahan whose recipe is one of itself (ADR-0040 §1) —
  // there is no separate "countable SKU" concept.
  SeedIngredient('botol-bintang', 'Bintang 330 ml', _pcs,
      opening: 48, lowAt: 12, pricePerUnit: 18500),
  SeedIngredient('kombucha', 'Kombucha rumahan', _l,
      opening: 12, lowAt: 3, pricePerUnit: 38000),
  ...
  SeedIngredient('sambal', 'Sambal', _kg,
      opening: 2, lowAt: 0.5, pricePerUnit: 71000, batchYield: 2),
  SeedIngredient('saus-kacang', 'Saus kacang', _kg,
      opening: 1.5, lowAt: 0.4, pricePerUnit: 42500, batchYield: 1.5),
];
...
const seedItemRecipes = <String, SeedRecipe>{
  ...
  'krupuk-side': SeedRecipe(base: [
    SeedQty('krupuk', 3, _pcs),
  ]),
  'pisang': SeedRecipe(base: [
  ...
  'es-teh': SeedRecipe(base: [
    SeedQty('teh', 8, _g),
    SeedQty('gula', 25, _g),
    SeedQty('es-batu', 250, _g),
  ]),
  'bintang': SeedRecipe(base: [
    SeedQty('botol-bintang', 1, _pcs),
  ]),
  'kombucha': SeedRecipe(base: [
    SeedQty('kombucha', 330, _ml),
  ]),
};
...
Map<String, dynamic> seedRecipePayload(SeedRecipe r) => {
      'base': _lines(r.base),
      'byVariant': {
        for (final e in r.byVariant.entries) e.key: _lines(e.value),
      },
      'byOption': {
        for (final e in r.byOption.entries) e.key: _lines(e.value),
      },
    };
